...
Reservation.create(user_id: User.all[0].id, hotel_id: Hotel.all[4].id, active: true, num_of_nights: 5)
Reservation.create(user_id: User.all[1].id, hotel_id: Hotel.all[5].id, active: true, num_of_nights: 1)  
Reservation.create(user_id: User.all[2].id, hotel_id: Hotel.all[5].id, active: false, num_of_nights: 6)
Reservation.create(user_id: User.all[3].id, hotel_id: Hotel.all[0].id, active: false, num_of_nights: 2)  
Reservation.create(user_id: User.all[3].id, hotel_id: Hotel.all[2].id, active: true, num_of_nights: 2)  